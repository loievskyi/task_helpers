from test_compressors.conftest import mock_compressor
from test_converters.conftest import task_converter, bytes_converter, custom_type_converter, converter_stub
